...
app.get('/grandline', async (req, res) => {
  ...
  res.send('<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><title>Grand Line</title><style>@import url(\'https://fonts.googleapis.com/css2?family=Oswald:wght@400;700&family=Roboto:wght@300;400&display=swap\');*{margin:0;padding:0;box-sizing:border-box;}body{background:#0a0a1a;min-height:100vh;padding:30px 20px;font-family:\'Roboto\',sans-serif;color:white;}.header{text-align:center;margin-bottom:40px;}.header h1{font-family:\'Oswald\',sans-serif;font-size:48px;letter-spacing:8px;color:#f39c12;text-shadow:0 0 30px rgba(243,156,18,.5);}.divider{width:200px;height:2px;background:linear-gradient(to right,transparent,#f39c12,transparent);margin:15px auto;}.header p{font-size:14px;color:#888;letter-spacing:3px;}.factions-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:25px;max-width:1400px;margin:0 auto;}.faction-card{border:2px solid;border-radius:12px;padding:20px;}.faction-title{font-family:\'Oswald\',sans-serif;font-size:22px;letter-spacing:3px;margin-bottom:5px;}.faction-header{display:flex;justify-content:space-between;align-items:center;cursor:pointer;}.faction-right{display:flex;align-items:center;gap:10px;}.faction-count{font-size:12px;color:#888;letter-spacing:2px;}.faction-arrow{font-size:14px;transition:transform .3s;}.faction-card.ouvert .faction-arrow{transform:rotate(180deg);}.faction-card.ouvert .members-grid{display:flex!important;flex-direction:column;gap:10px;margin-top:15px;padding-top:15px;border-top:1px solid rgba(255,255,255,.1);} }.members-grid{display:flex;flex-direction:column;gap:10px;}.member-card{display:flex;align-items:center;gap:12px;background:rgba(255,255,255,.05);border-radius:8px;padding:10px;}.member-avatar{width:50px;height:50px;border-radius:50%;border:2px solid rgba(255,255,255,.2);object-fit:cover;}.member-info{flex:1;}.member-name{font-family:\'Oswald\',sans-serif;font-size:16px;}.member-perso{font-size:12px;color:#aaa;font-style:italic;}.member-prime{font-size:12px;color:#f39c12;}.empty{font-size:13px;color:#555;font-style:italic;text-align:center;padding:20px;}.footer{text-align:center;margin-top:40px;font-size:12px;color:#555;letter-spacing:3px;}</style></head><body><div class="header"><h1>GRAND LINE</h1><div class="divider"></div><p>CARTE DES EQUIPAGES - NEYLABRISE</p></div><div class="factions-grid">' + factionCards + '</div><div class="footer"><p>NeyLaBrise - Grand Line</p></div><script>function toggleFaction(card){var grid=card.querySelector(".members-grid");var arrow=card.querySelector(".faction-arrow");if(grid.style.display==="none"||grid.style.display===""){grid.style.display="flex";grid.style.flexDirection="column";grid.style.gap="10px";grid.style.marginTop="15px";if(arrow)arrow.style.transform="rotate(180deg)";}else{grid.style.display="none";if(arrow)arrow.style.transform="rotate(0deg)";}}</script></body></html>');
});
