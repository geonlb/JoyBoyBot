...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    body{background:#0a0a1a url(/persos/onepiecegrandline.png) center/cover fixed;min-height:100vh;padding:30px 20px;font-family:\'Roboto\',sans-serif;color:white;}
